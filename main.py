...
def generate_plots(df, output_dir):
    ...
    # 1. Plot: Iterations vs C1 for each method (Armijo)
    print("\n1. Creating C1 parameter plots for Armijo methods...")
    ...
    # 2. Plot: Iterations vs C2 for each method (Wolfe)
    print("\n2. Creating C2 parameter plots for Wolfe methods...")
    ...
    # 3. Plot: Iterations vs Alpha for each method
    print("\n3. Creating Alpha parameter plots for all methods...")
    ...
    # 4. Heatmap: C1 vs C2 for Wolfe methods (average iterations) - using matplotlib only
    print("\n4. Creating heatmaps for Wolfe methods...")
    for method in wolfe_df['method'].unique():
        method_df = wolfe_df[wolfe_df['method'] == method]
    ...
    # 6. Comparison plot: Best parameters across methods
